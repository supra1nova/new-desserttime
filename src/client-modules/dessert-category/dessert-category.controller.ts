...
export class DessertCategoryController {
  ...
  async getSessionDessertCategory(
    @Param() dessertSessionDto: DessertSessionDto,
  ) {
    return this.dessertCategoryService.getSessionDessertCategory(
      dessertSessionDto,
    );
  }
  ...
  async getSessionSubDessertCategory(@Param() parentIdDto: ParentIdDto) {
    return this.dessertCategoryService.getSessionSubDessertCategory(
      parentIdDto,
    );
  }
  ...
  @Post('one')
  async postDessertCategory(
    @Body() firstCategoryAppendDto: FirstCategoryAppendDto,
  ) {
    return this.dessertCategoryService.postDessertCategory(
  ...
  async deleteDessertCategory(
    @Param() dessertCategoryIdDto: DessertCategoryIdDto,
  ) {
    return this.dessertCategoryService.deleteDessertCategory(
